   ...
   <div class="main">
      <div class="main-content container-xxl justify-content-center p-2">
         ...
         <div class="mid-content">
            <div class="mc-block">
               <section id="writing">
                  <h2>Написание плагинов</h2><br>
                  <p class="article">В данной статье разберёмся как создать плагин для Navisworks, 
                     который отображает пользователю сообщение «Hello World».
                  </p>
               </section>
               
               <section id="create">
                  <h2>Чтобы создать плагин</h2><br>
                  <p class="article">
                     Создайте проект библиотеки классов под названием BasicPlugin.
                  </p>
                  <p class="imgcenter">
                     <img src="imgs/a_4/create_1.jpg" style="width: 800px">
                  </p><br>
                  <p class="article">
                     Добавьте необходимые ссылки на сборки API.
                  </p>
                  <p class="imgcenter">
                     <img src="imgs/a_4/create_3.jpg" style="width: 800px">
                  </p><br>
                  <p class="article">
                     Добавьте любые другие необходимые ссылки.
                  </p>
                  <p class="imgcenter">
                     <img src="imgs/a_4/create_4.jpg" style="width: 800px">
                  </p><br>
                  <p class="article">
                     Вставьте код, необходимый для отображения окна сообщения на экране:
                  </p>
                  <div class="code-box">
                     <div class="cb-header">
   ...
   public class ABasicPlugin : AddInPlugin
   {
      public override int Execute(params string[] parameters)
      {
         ...
         return 0;
                  ...
                  <p class="article">
                     Создайте проект и скопируйте сборку в структуру в каталоге плагинов Navisworks.
                  </p>
                  <p class="article">
                     &#60;disk&#62;:\Program Files\Autodesk\Navisworks Manage 2019\Plugins\BasicPlugin.ADSK
                  </p>
                  <p class="article">
                     Это можно сделать, используя шаг после сборки.
                     Запустите Navisworks и выберите плагин на вкладке «Надстройки».
                  </p>
                  <p class="article">
                     Hello, world!
                  </p>
                  <p class="imgcenter">
                     <img src="imgs/a_4/create_5.jpg" style="width: 800px">
                  </p><br>
               </section>
            ...
            <div class="mc-toc mt-3 mb-5 my-lg-0 mb-lg-5 px-sm-1 text-body-secondary">
               ...
               <div class="collapse d-block">
                  <nav id="TableOfContents">
                     <ul>
                        <li><a href="#writing" class="active">Написание плагинов</a></li>
                        <li><a href="#create">Чтобы создать плагин</a>
