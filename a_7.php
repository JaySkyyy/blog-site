   ...
   <div class="main">
      <div class="main-content container-xxl justify-content-center p-2">
         ...
         <aside>
            <div class="collapsible-sidebar flex-shrink-0 p-3" style="position: sticky; top: 5rem; ">
               ...
               <ul class="list-unstyled ps-0">
                  ...
                  <li class="mb-1">
                     <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
                        data-bs-toggle="collapse" data-bs-target="#others-collapse" aria-expanded="true">
                        Другое
                     </button>
                     <div class="collapse show" id="others-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
         ...
         <div class="mid-content">
            <div class="mc-block">
               <section id="tree">
                  <h2>Древовидные структуры</h2><br>
                  <p class="article">
                     Некоторые части API имеют структуры родительского/дочернего или иерархического характера. 
                     Используемые базовые классы являются общими для различных частей API и могут быть найдены 
                     в различных областях, включая наборы выбора.
                  </p>
               </section>
               
               <section id="saveditem">
                  <h2>SavedItem</h2><br>
                  <p class="article">
                     Этот абстрактный базовый класс представляет элемент, который сохраняется в файле Navisworks.
                  </p>
                  <p class="article">
                     Поскольку производные классы сами могут содержать коллекции других производных элементов SavedItem, 
                     существует свойство IsGroup, которое идентифицирует экземпляр как производный от GroupItem.
                  </p>
               </section>

               <section id="groupitem">
                  <h2>GroupItem</h2><br>
                  <p class="article">
                     Этот абстрактный базовый класс, также производный от SavedItem, представляет элемент, который может 
                     иметь дочерние элементы производные от SavedItem.
                  </p>
                  <p class="article">
                     Свойство GroupItem.Children является экземпляром SavedItemCollection и предоставляет коллекцию SavedItems.
                  </p>
               </section>
            ...
            <div class="mc-toc mt-3 mb-5 my-lg-0 mb-lg-5 px-sm-1 text-body-secondary">
               ...
               <div class="collapse d-block">
                  <nav id="TableOfContents">
                     <ul>
                        <li><a href="#tree" class="active">Деревья</a></li>
                        <li><a href="#saveditem">SavedItem</a>
                        <li><a href="#groupitem">GroupItem</a>
