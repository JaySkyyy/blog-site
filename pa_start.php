         ...
         <div class="mid-content">
            <div class="mc-block">
               <section id="how-it-works">
                  <h2>Введение</h2>
                  <p class="article">Navisworks Manage – это мощное программное обеспечение для просмотра и анализа больших проектов. Оно используется преимущественно в строительной индустрии для дополнения 3D-пакетов проектирования (таких как Autodesk Revit, AutoCAD и MicroStation).
<br>Основной инструмент, которым мы будем пользоваться - это .NET API. 
<br>Начиная с версии Navisworks 2011, доступен .NET программный интерфейс.
                  </p>
                  <p class="article">
С его помощью возможно:
<ul  class="article">
   <li>- Создавать пользовательские плагины для Navisworks.</li>
   <li>- Автоматизировать задачи в Navisworks, например, импорт данных или обработку моделей.</li>
   <li>- Взаимодействовать с Navisworks извне, не используя графический интерфейс.</li>
   <li>- Встраивать новые элементы управления .NET в свои собственные приложения.</li>
</ul>
                  </p>
               </section>
               
               <section id="brand">
                  <h2>Что мы рассмотрим?</h2>
                  <p class="article">
                     В ходе уроков мы будем рассматривать несколько возможных сборок. Их всего три:
                  </p>
                     <ul class="article">
                        <li>- Autodesk.Navisworks.Api.dll. Это основной API, используемый при работе с плагинами или с Controls API.</li>
                        <li>- Autodesk.Navisworks.Automation.dll. Используется при работе с Automation для управления Navisworks.</li>
                        <li>- Autodesk.Navisworks.Controls.dll. Используется, когда требуются элементы управления графическим интерфейсом или доступ к инструментам Navisworks в сторонних приложениях.</li>
                     </ul>
               </section>
            ...
            <div class="mc-toc mt-3 mb-5 my-lg-0 mb-lg-5 px-sm-1 text-body-secondary">
               ...
               <div class="collapse d-block">
                  <nav id="TableOfContents">
                     <ul>
                        <li><a href="#how-it-works" class="active">Введение</a></li>
                        <li><a href="#brand">Что мы рассмотрим?</a>
